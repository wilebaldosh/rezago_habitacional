...
# Leemos los datos desde archivos
...
# Eliminamos la columna largo
vivienda <- vivienda[, -c(65)]
...
# Aplicamos la condición para identificar el tipo de rezago
